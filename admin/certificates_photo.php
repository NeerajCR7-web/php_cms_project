...
if(isset($_FILES['photo'])) {
    ...
    set_message('Certificate photo has been updated');
    header('Location: certificates.php');
    die();
}
...
if(isset($_GET['id'])) {
    if(isset($_GET['delete'])) {
        ...
        set_message('Certificate photo has been deleted');
        header('Location: certificates.php');
        die();
    }
...
<?php if($record['photo']): ?>
    ...
    <p><a href="certificates_photo.php?id=<?php echo $_GET['id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this Photo</a></p>
<?php endif; ?>
